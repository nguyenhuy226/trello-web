    ...
    <section className="banner style2" style={{'--background': '#cde6fb'}}>
        <div className="container">
          <div className="info">
            ...
            <a className="btn white round" style={{'--color-Btn': '#70b6f1'}} href="./register.html">đăng ký</a>
          </div>
        </div>
        ...
        <div className="container">
          <p className="des">Many Laravel apps don’t warrant the complexity of a full front-end framework like Vue
            or
            React. In this series, we’ll walk through a handful of simple ways to add dynamic functionality
            to
            your apps.</p>
          ...
          <div className="row row-check">
            ...
            <div className="col-md-6">Dạy và thực hành thêm bài tập online
              thông qua Skype.</div>
            <div className="col-md-6">Được các mentor và các bạn trong team Spacedev hổ trợ thông qua group
              Spacedev
              Facebook
            ...
            <div className="teacher">
              ...
              <div className="info">
                ...
                <p className="intro">
                  ...
                  humans
                  we have learned how to read and write and while that is incredible, we are also
                  already
